            ...
            <Columns>
                ...
                <%--<asp:TemplateField HeaderText="编辑会员">
                    <ItemTemplate>
                        ...
                        <a href="../user/UpaterUser.aspx?UserID=<%#DataBinder.Eval (Container.DataItem ,"UserID")%>" title ="修改<%#DataBinder.Eval (Container.DataItem ,"Username") %>的个人信息" target="_blank" class="STYLE6">修改</a> 
                        <a href="../user/EditUserPwd.aspx?UserID=<%#DataBinder.Eval (Container.DataItem ,"UserID")%>" title ="修改密码<%#DataBinder.Eval (Container.DataItem ,"Username") %>的个人信息" target="_blank" class="STYLE6">修改密码</a>
