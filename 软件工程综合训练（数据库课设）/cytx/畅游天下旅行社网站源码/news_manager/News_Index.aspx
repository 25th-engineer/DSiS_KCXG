...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style ="width:80%; background-color:#FFFFFF" cellpadding ="0" cellspacing="0">
      ...
      <table style ="width:80%; background-color:#FFFFFF" cellpadding ="0" cellspacing="0">
        <tr style ="height:25px;" class ="STYLE7TT">
            <td align ="left" class ="STYLE11" style ="width:80%">华坪资源列表</td>
            <td class ="STYLE11" style ="width:20%"><a href ="NewsFenl.aspx?NewFl=华坪资源" target ="_blank" class="STYLE11">更多&gt;&gt;&gt;</a></td>
        </tr>
         <tr style ="width:80%">
            <td align ="left">
    ...
    <table style ="width:80%; background-color:#FFFFFF" cellpadding ="0" cellspacing="0">
        <tr style ="height:25px;" class ="STYLE7TT">
            <td align ="left" class ="STYLE11" style ="width:80%">公告列表</td>
            <td class ="STYLE11" style ="width:20%"><a href ="NewsFenl.aspx?NewFl=公告" target ="_blank" class="STYLE11">更多&gt;&gt;&gt;</a></td>
        </tr>
         <tr style ="width:80%">
            <td align ="left">
                <asp:GridView ID="GridView8" runat="server"  ShowHeader="false" AutoGenerateColumns="false" Width ="100%"  BorderStyle="none" GridLines="None">
                    <Columns >
                        <asp:TemplateField >
                            <ItemTemplate>
                                ·<a href ="XinwenInfo.aspx?NewID=<%#DataBinder.Eval (Container.DataItem ,"NewID")%>" class ="STYLE13"><%#DataBinder.Eval (Container.DataItem ,"Title") %></a> [<%#DataBinder.Eval (Container.DataItem ,"AddTime")%>]
