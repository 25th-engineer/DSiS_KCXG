<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectUser.aspx.cs" Inherits="user_SelectUser" EnableEventValidation="false"%>
...
<head runat="server">
    <title>用户信息管理</title>
    <link href= "../CSS/StyleSheet.css" type ="text/css" rel ="Stylesheet" charset ="gb2312"  />
...
<center>
    ...
    <table style ="height:25px; width:570px" cellpadding="0" cellspacing="0" class="StyleTabTd"  >
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="邮箱地址">
                    ...
                    <ItemStyle HorizontalAlign="Left" Width="5%" BorderWidth="1px" />
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Font-Size="Small" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="地区">
                    ...
                    <ItemStyle HorizontalAlign="Left" Width="7%" BorderWidth="1px" />
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Font-Size="Small" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="个人简历">
                  ...
                  <asp:TemplateField HeaderText="注册日期">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="6%" BorderWidth="1px" CssClass="STYLE6" />
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Font-Size="Small" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText ="删除" >
                    <ItemTemplate >
                        <asp:ImageButton  ID ="ImgButton1" runat ="server" ImageUrl="~/Images/delete.gif" CommandName ="delete"
                         CommandArgument ='<%#DataBinder .Eval (Container .DataItem ,"UserID") %>' OnClientClick="return confirm('确定删除吗？')" /> 
                        <%--<asp:ImageButton  ID ="ImageButton1" runat ="server" ImageUrl="~/Images/delete.gif" CommandName ="update"
