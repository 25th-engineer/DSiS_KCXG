...
def USE_SHA(text):
    if not isinstance(text, bytes):
        text = bytes(text, 'utf-8')
    sha = hashlib.sha256(text)  # ha = hashlib.sha1(text)
...
if __name__ == '__main__':
    '''
    print("AES:")
    aes_test = USE_AES("assssssssdfasasasasa")  #  tu5sdfgd8wre9yrkyfgs
    a = aes_test.encrypt("Little Tang is lovely!")
    print("Encrypted a: \n" + str(a))
    ...
    print("RSA:")
    rsa_test = USE_RSA()
    a = rsa_test.rsaEncrypt("A few nights ago I received an email from \"2CO\" asking me to update my personal data.")
    print("Encrypted a: \n" + str(a))
    ...
    print("DES:")
    des_test = USE_DES(b"plkfk5z8", b"pv6efag9")  # key, iv # 12345678 12345678
    a = des_test.encrypt("In recent days, I was one of the unfortunate persons to receive the \"Mydoom\" worm emails.")
    print( "Encrypted a: \n" + str(a) )
    ...
    print("Encrypted a: " + str(a))
    b = des3_test.decrypt(a)
    print("Decrypted b: " + str(b))
    print("**************\n")

    print("MD-5:")
    md5_test = USE_MD5("测试签名")
    print("Signed md5_test: " + str(md5_test))
    print("**************\n")

    print("HMAC:")
    hmac_test = USE_HMAC("123456", "测试")
    print("Encrypted hmac_test: " + str(hmac_test))
    print("**************\n")
    '''


    print("SHA256:")
    plaintext_sha256 = "abcdefghijklmnopqrstuvwxyx"
    sha_test = USE_SHA(plaintext_sha256)
    print("plaintext_sha256: \n" + plaintext_sha256)
    print("Message-digest sha256_test: \n" + str(sha_test))
    # print("**************\n")
    ###############
