...
<div id="out">
    <div id="list">
     ...
     <form action="../course/updateOneCourse">
      ...
      <div id="pageDivide">
        <ul class="pager"> 
            <li><a href="../course/listCourseBySellerCourseType?coursePageIndex=1&sellerID=${sellerID}" class="pagea">首页</a></li>
            <li><a href="../course/listCourseBySellerCourseType?coursePageIndex=${coursePageIndex-1 }&sellerID=${sellerID}"><</a></li>          
             <c:forEach begin="${coursePageIndex }" end="${coursePageCount}" step="1" var="i">
            	<li><a href="../course/listCourseBySellerCourseType?coursePageIndex=${i}&sellerID=${sellerID}">${i}</a></li>
            </c:forEach>
