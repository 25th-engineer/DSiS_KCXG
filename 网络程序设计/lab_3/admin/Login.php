...
class Login
{
	...
	public function checkUser()
	{
		...
		$sql = "SELECT stu_id FROM students WHERE email = '".$this->email."' and password = '".$this->password."'";
