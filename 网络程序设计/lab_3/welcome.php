    ...
    <div class="container">
      <div class="content">
          <div class="starter-template">
                <!-- 这里做了修改，其他地方自由发挥 -->
            <h1>个人作业</h1>
            <p class="lead">作业就水一水咯~~~<br>数据库表的逻辑没有严格考虑……</p>
          </div>  
          <!-- 注册表单 -->
              ...
              <form action="admin/Register.php" method="post" accept-charset="utf-8" class="form-horizontal">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="stu_name" class="col-sm-4 control-label">Name:</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="stu_name" id="stu_name" minlength="2" maxlength="20" placeholder="stu_name" required="">
                    </div>
                    <!-- 错误提示信息 -->
                    ...
                    <div class="form-group">
                        <label for="stu_id" class="col-sm-4 control-label">Student ID:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="stu_id" id="stu_id" minlength="2" maxlength="20" placeholder="stu_id" required="">
                        </div>
                        <!-- 错误提示信息 -->
                        <h6 style="color: red;" id="dis_un"></h6>
                    </div>
